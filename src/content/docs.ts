...
export const DOC_SECTIONS: DocSection[] = [
  {
    ...
    icon: "🛡️",
    blocks: [
      { t: "p", text: "MATRIX is an AI Cyber Safety Platform for users aged 11–17, operated by the THAMJJ13.TOP White Hat Team. It combines a cybersecurity AI assistant, a screenshot scanner, a verified scam library, guided reporting, emergency help, courses and verifiable certificates — all in one teen-first, privacy-first product." },
      { t: "h2", text: "What MATRIX does" },
      { t: "ul", items: [
        "Answers cybersecurity questions — phishing, passwords, scams, privacy, device security and more.",
        "Analyses suspicious screenshots (SMS, email, login pages, payment requests) with a risk level and confidence score.",
        "Teaches cyber safety through structured courses with quizzes.",
        "Issues verifiable certificates for completed courses.",
        "Guides you to official, verified reporting resources — it never invents reporting websites.",
        "Provides calm, defensive steps in emergencies — account hacked, OTP shared, money lost, online threats.",
      ]},
      ...
      { t: "callout", tone: "info", text: "MATRIX only answers cybersecurity-related questions. For anything else it politely redirects — this keeps the assistant focused and safe." },
      { t: "h2", text: "How privacy works" },
      { t: "p", text: "Every record is protected by PostgreSQL Row Level Security — you can only ever see your own data. Personal information (emails, phone numbers, codes, passwords, addresses) is redacted before anything is sent to the AI model, and sensitive identity documents are never sent to the AI at all." },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: "💬",
    blocks: [
      { t: "p", text: "MATRIX AI is your cyber safety assistant. It's powered by a large language model (Groq) behind a secure server-side AI gateway — the app never calls the model directly from your browser." },
      { t: "h2", text: "What it can do" },
      { t: "ul", items: [
        "Explain phishing, scams, passwords, MFA, privacy, malware and device security.",
        "Analyse suspicious messages and screenshots with structured guidance.",
        "Walk you through incident response — account hacked, code shared, money lost.",
        "Recommend verified reporting resources for your country.",
        "Teach with examples, safe practices, common mistakes and quick quizzes.",
      ]},
      { t: "h2", text: "What it won't do" },
      { t: "ul", items: [
        "Answer unrelated questions (math homework, essays, jokes) — it politely redirects to cybersecurity topics.",
        "Help with harmful activity: credential theft, malware creation, account takeover, DDoS, phishing infrastructure, detection evasion.",
        "Invent reporting websites or phone numbers — reporting info always comes from the verified resources database.",
        "Ask for or repeat your passwords, codes, ID numbers or contact details.",
      ]},
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: "ul", items: [
        ...
        "Attach a screenshot — it's analysed by the scanner and the result lands in your chat.",
