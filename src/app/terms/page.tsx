...
const SECTIONS = [
  ...
  { title: "6. Privacy", body: "Your data is protected by Supabase PostgreSQL Row Level Security. Personal information is redacted before it reaches the AI. See the Privacy page for full details." },
